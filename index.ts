type Elevator<T> = T extends string
    ...
    ? [Elevator<A>, Elevator<B>, Elevator<C>, Elevator<D>]
    : T extends readonly [infer A, infer B, infer C, infer D, infer E]
    ? [Elevator<A>, Elevator<B>, Elevator<C>, Elevator<D>, Elevator<E>]
    : T extends readonly [infer A, infer B, infer C, infer D, infer E, infer F]
    ? [ Elevator<A>, Elevator<B>, Elevator<C>, Elevator<D>, Elevator<E>, Elevator<F> ] // prettier-ignore
    : T extends readonly [ infer A, infer B, infer C, infer D, infer E, infer F, infer G ] // prettier-ignore
    ? [ Elevator<A>, Elevator<B>, Elevator<C>, Elevator<D>, Elevator<E>, Elevator<F>, Elevator<G> ] // prettier-ignore
...
type DefaultInterface<NonDefault, Defaults> = NonDefault & {
    -readonly [K in keyof Defaults]+?: Default<
        Elevator<Defaults[K]>,
        Defaults[K]
    >
}
